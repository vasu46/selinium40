...
public class General extends Global {
	...
	public void login_App() {
		...
		Log.info("user Loging is successfull");
	  }
	public void logout_App() {
		...
		Log.info("Application will be Logout sucessfull");
	}
	public void add_Employee() {
		...
		Log.info("Add new Employee SucessFull");
	...
	public void deleteEmployee() {
		...
		Log.info("Delete Employee is Successfull");
		exit_frame();
	  }
	...
	public void edit_Employee() {
		...
		Log.info("Employee is AuccessFull");
	}
